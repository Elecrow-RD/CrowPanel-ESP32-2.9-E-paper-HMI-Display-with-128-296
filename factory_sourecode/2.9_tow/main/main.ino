...
void setup()
{
  ...
  EPD_ShowPicture(0, 0, 296, 128, gImage_boot_setup, BLACK);
  ...
  EPD_HW_RESET();
  EPD_ShowPicture(0, 0, 296, 128, gImage_boot_setup_1, BLACK);
  EPD_DisplayImage(ImageBW);
  EPD_FastUpdate();
  //  EPD_PartUpdate();
  EPD_Sleep();
  ...
  EPD_HW_RESET();
  EPD_ShowPicture(0, 0, 296, 128, gImage_boot_setup_info, BLACK);
  EPD_DisplayImage(ImageBW);
  EPD_FastUpdate();
  //  EPD_PartUpdate();
  EPD_Sleep();
  ...
  clear_all();
  EPD_HW_RESET();
  EPD_ShowPicture(0, 0, 296, 128, gImage_menu, BLACK);
  EPD_DisplayImage(ImageBW);
  //  EPD_FastUpdate();
  EPD_PartUpdate();
  EPD_Sleep();
...
void test_title()
{
  EPD_GPIOInit();
  clear_all();
  EPD_ShowString(75, 48, "Test Program", BLACK, 24);
  EPD_DisplayImage(ImageBW);
  EPD_FastUpdate();
  //    EPD_PartUpdate();
  EPD_Sleep();
  ...
  switch (command[0])
  {
    ...
    case 'U':
      if (test_flag == true)
      {
        ...
        //        EPD_GPIOInit();
        clear_all();
        EPD_ShowPicture(0, 0, 296, 128, gImage_image, BLACK);
        EPD_DisplayImage(ImageBW);
        //        EPD_FastUpdate();
        EPD_PartUpdate();
        EPD_Sleep();
...
void show_home_menu()
{
  //    clear_all();
  EPD_HW_RESET();
  EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_menu, BLACK);
  EPD_DisplayImage(ImageBW);
  //  EPD_FastUpdate();
  EPD_PartUpdate();
  EPD_Sleep();
...
void show_home_menu1()
{
  //  clear_all();
  EPD_HW_RESET();
  EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_menu1, BLACK);
  EPD_DisplayImage(ImageBW);
  //  EPD_FastUpdate();
  EPD_PartUpdate();
  EPD_Sleep();
...
void show_home_menu2()
{
  //  clear_all();
  EPD_HW_RESET();
  EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_menu2, BLACK);
  EPD_DisplayImage(ImageBW);
  //  EPD_FastUpdate();
  EPD_PartUpdate();
  EPD_Sleep();
...
void show_description(int show_pos)
{
  ...
  switch (show_pos)
  {
    case 0:
      //第一页介绍
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_description, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 1:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_description1, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 2:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_description2, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 3:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_description3, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 4:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_description4, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 5:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_description5, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
...
void show_image_example(int show_pos)
{
  ...
  switch (show_pos)
  {
    case 0:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_image, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 1:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_image1, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 2:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_image2, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 3:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_image3, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 4:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_image4, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 5:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_image5, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 6:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_image6, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
...
void show_scenario_example_pos(int show_pos)  //scenario 显示游标
{
  ...
  switch (show_pos)
  {
    case 0:
      EPD_HW_RESET();
      EPD_ShowPicture(20, 26, 8, 76, gImage_scenario_pos, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 1:
      EPD_HW_RESET();
      EPD_ShowPicture(20, 26, 8, 76, gImage_scenario_pos1, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 2:
      EPD_HW_RESET();
      EPD_ShowPicture(20, 26, 8, 76, gImage_scenario_pos2, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 3:
      EPD_HW_RESET();
      EPD_ShowPicture(20, 26, 8, 76, gImage_scenario_pos3, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
    ...
    case 4:
      EPD_HW_RESET();
      EPD_ShowPicture(20, 26, 8, 76, gImage_scenario_pos4, BLACK);
      EPD_DisplayImage(ImageBW);
      EPD_FastUpdate();
      //  EPD_PartUpdate();
      EPD_Sleep();
...
void show_scenario_example_ctl(int show_pos) //scenario 显示开关
{
  ...
  switch (show_pos)
  {
    case 0:
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(140, 26, 136, 12, gImage_scenario_ctl_on, BLACK);
        EPD_DisplayImage(ImageBW);
        EPD_FastUpdate();
        //  EPD_PartUpdate();
        EPD_Sleep();
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(140, 26, 136, 12, gImage_scenario_ctl_off, BLACK);
        EPD_DisplayImage(ImageBW);
        EPD_FastUpdate();
        //  EPD_PartUpdate();
        EPD_Sleep();
    ...
    case 1:
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(140, 42, 136, 12, gImage_scenario_ctl_on, BLACK);
        EPD_DisplayImage(ImageBW);
        EPD_FastUpdate();
        //  EPD_PartUpdate();
        EPD_Sleep();
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(140, 42, 136, 12, gImage_scenario_ctl_off, BLACK);
        EPD_DisplayImage(ImageBW);
        EPD_FastUpdate();
        //  EPD_PartUpdate();
        EPD_Sleep();
    ...
    case 2:
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(140, 58, 136, 12, gImage_scenario_ctl_on, BLACK);
        EPD_DisplayImage(ImageBW);
        EPD_FastUpdate();
        //  EPD_PartUpdate();
        EPD_Sleep();
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(140, 58, 136, 12, gImage_scenario_ctl_off, BLACK);
        EPD_DisplayImage(ImageBW);
        EPD_FastUpdate();
        //  EPD_PartUpdate();
        EPD_Sleep();
    ...
    case 3:
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(140, 74, 136, 12, gImage_scenario_ctl_on, BLACK);
        EPD_DisplayImage(ImageBW);
        EPD_FastUpdate();
        //  EPD_PartUpdate();
        EPD_Sleep();
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(140, 74, 136, 12, gImage_scenario_ctl_off, BLACK);
        EPD_DisplayImage(ImageBW);
        EPD_FastUpdate();
        //  EPD_PartUpdate();
        EPD_Sleep();
    ...
    case 4:
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(140, 90, 136, 12, gImage_scenario_ctl_on, BLACK);
        EPD_DisplayImage(ImageBW);
        EPD_FastUpdate();
        //  EPD_PartUpdate();
        EPD_Sleep();
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(140, 90, 136, 12, gImage_scenario_ctl_off, BLACK);
        EPD_DisplayImage(ImageBW);
        EPD_FastUpdate();
        //  EPD_PartUpdate();
        EPD_Sleep();
      ...
      case 5:
        ...
        if (peg_pos == 1)
        {
          ...
          else if (slide_pos == 2)
          {
            ...
            clear_all();
            EPD_ShowPicture(0, 0, EPD_W, EPD_H, gImage_scenario_home, BLACK);
            EPD_DisplayImage(ImageBW);
            EPD_FastUpdate();
            //  EPD_PartUpdate();
            EPD_Sleep();
